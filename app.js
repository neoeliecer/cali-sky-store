...
const DEFAULT_PROPERTIES = [
  ...
  {
    id: "prop-arr-6",
    title: "Apartamento en Arriendo El Caney",
    type: "apartamento",
    zone: "Sur",
    barrio: "El Caney",
    price: 1100000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=600&q=80",
    address: "Carrera 94 # 16-40, Apt 203, El Caney, Cali",
    phone: "+57 315 200 3300",
    owner: "Alberto Muñoz",
    source: "Fincaraiz",
    sourceLink: "https://fincaraiz.com.co/arriendo/apartamento/el-caney-cali",
    grokAnalysis: "Apartamento en conjunto residencial tranquilo del sur de Cali. Tres habitaciones amplias, cocina integral y zona de ropas. Cerca a colegios y centros comerciales.",
    advisorNote: "Propietario en el exterior, negocia directamente por WhatsApp. Disponible de inmediato, no requiere fiador si hay depósito."
  },
  {
    id: "prop-arr-7",
    title: "Apto en Arriendo Meléndez Cali",
    type: "apartamento",
    zone: "Sur",
    barrio: "Meléndez",
    price: 850000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=600&q=80",
    address: "Calle 13 # 70-20, Apt 104, Meléndez, Cali",
    phone: "+57 316 400 5500",
    owner: "Carmen Lucía Trujillo",
    source: "Facebook Marketplace",
    sourceLink: "https://facebook.com/marketplace/cali/arriendo-melendez",
    grokAnalysis: "Apartamento moderno cerca a la Universidad del Valle. Dos habitaciones, dos baños completos, cocina abierta y parqueadero cubierto incluido.",
    advisorNote: "Sector universitario con alta demanda. Propietaria acepta pagos quincenales para profesionales independientes."
  },
  {
    id: "prop-arr-8",
    title: "Apartamento en Arriendo El Ingenio Sur",
    type: "apartamento",
    zone: "Sur",
    barrio: "El Ingenio",
    price: 1400000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=600&q=80",
    address: "Carrera 83 # 14B-10, Apt 502, El Ingenio, Cali",
    phone: "+57 314 600 7700",
    owner: "Hernando Ospina",
    source: "Metrocuadrado",
    sourceLink: "https://metrocuadrado.com/arriendo/apartamento/el-ingenio-cali",
    grokAnalysis: "Amplio apartamento con balcón, zona social y gym. Conjunto con portería 24h y cámaras de seguridad en todo el perímetro. Excelente distribución.",
    advisorNote: "Canon incluye administración. Propietario busca arrendatario a largo plazo mínimo 2 años. Negociable el mes de gracia."
  },
  {
    id: "prop-arr-9",
    title: "Apartamento en Arriendo San Antonio Oeste",
    type: "apartamento",
    zone: "Oeste",
    barrio: "San Antonio",
    price: 1200000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=600&q=80",
    address: "Calle 2 Oeste # 5-45, Apt 301, San Antonio, Cali",
    phone: "+57 311 800 9900",
    owner: "Isabella Ramírez",
    source: "Finca Raíz",
    sourceLink: "https://fincaraiz.com.co/arriendo/apartamento/san-antonio-cali",
    grokAnalysis: "Encantador apartamento en el barrio más bohemio de Cali. Vista al cerro, pisos de madera, ventanas coloniales y balcón con vista al Parque San Antonio.",
    advisorNote: "Sin parqueadero pero a 2 min de bahía de taxis. Ideal para parejas o personas solas que valoran la cultura y vida de barrio."
  },
  {
    id: "prop-arr-10",
    title: "Apto en Arriendo Alameda Centro",
    type: "apartamento",
    zone: "Centro",
    barrio: "Alameda",
    price: 1000000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=600&q=80",
    address: "Carrera 24 # 4-55, Apt 402, Alameda, Cali",
    phone: "+57 312 100 2200",
    owner: "Gustavo Andrade",
    source: "OLX Cali",
    sourceLink: "https://olx.com.co/item/arriendo-apto-alameda-cali",
    grokAnalysis: "Apartamento ejecutivo en Alameda, uno de los sectores más cotizados del centro de Cali. Acabados modernos, cocina equipada y seguridad privada.",
    advisorNote: "A 3 minutos de Unicentro Alameda y zona de restaurantes. Propietario acepta arrendatario con empresa o teletrabajo."
  },
  {
    id: "prop-arr-11",
    title: "Apartamento en Arriendo La Flora Norte",
    type: "apartamento",
    zone: "Norte",
    barrio: "La Flora",
    price: 1300000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=600&q=80",
    address: "Avenida 3N # 54-20, Apt 301, La Flora, Cali",
    phone: "+57 313 300 4400",
    owner: "Patricia Sánchez",
    source: "Fincaraiz",
    sourceLink: "https://fincaraiz.com.co/arriendo/apartamento/la-flora-norte-cali",
    grokAnalysis: "Apartamento remodelado en el norte de Cali, sector La Flora. Tres habitaciones, dos baños, balcón con vista norte y parqueadero techado.",
    advisorNote: "Propietaria muy flexible. Acepta mascotas pequeñas y contrato desde 6 meses. Canon no incluye servicios."
  },
  {
    id: "prop-arr-12",
    title: "Apartamento en Arriendo Santa Mónica Norte",
    type: "apartamento",
    zone: "Norte",
    barrio: "Santa Mónica",
    price: 1450000,
    ...
    area: 98,
    parking: 1,
    features: ["seguridad", "balcon"],
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=600&q=80",
    address: "Calle 52N # 4BN-30, Apt 204, Santa Mónica, Cali",
    phone: "+57 318 500 6600",
    owner: "Fabio Castaño",
    source: "Metrocuadrado",
    sourceLink: "https://metrocuadrado.com/arriendo/apartamento/santa-monica-cali",
    grokAnalysis: "Apartamento familiar en Santa Mónica, norte de Cali. Conjunto moderno con zona de BBQ, salón comunal y vigilancia 24h. Tres habitaciones amplias.",
    advisorNote: "El conjunto tiene restricción de ruido nocturno. Ideal para familias. Propietario solicita referencias laborales."
  },
  {
    id: "prop-arr-13",
    title: "Apartamento en Arriendo Versalles Norte",
    type: "apartamento",
    zone: "Norte",
    barrio: "Versalles",
    price: 980000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=600&q=80",
    address: "Carrera 1N # 47-15, Apt 102, Versalles, Cali",
    phone: "+57 319 700 8800",
    owner: "Liliana Herrera",
    source: "Facebook Marketplace",
    sourceLink: "https://facebook.com/marketplace/cali/arriendo-versalles",
    grokAnalysis: "Acogedor apartamento en Versalles norte. Dos habitaciones con closet, dos baños, cocina independiente y parqueadero. Conjunto pequeño y tranquilo.",
    advisorNote: "Propietaria vive en el primer piso del mismo conjunto. Muy buen mantenimiento del edificio. Agua incluida en el canon."
  },
  {
    id: "prop-arr-14",
    title: "Apto en Arriendo Tequendama Sur-Centro",
    type: "apartamento",
    zone: "Sur",
    barrio: "Tequendama",
    price: 1250000,
    ...
    deal: "Arriendo",
    image: "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=600&q=80",
    address: "Av. Roosevelt # 38-45, Apt 801, Tequendama, Cali",
    phone: "+57 310 900 1100",
    owner: "Andrés Mejía",
    source: "Fincaraiz",
    sourceLink: "https://fincaraiz.com.co/arriendo/apartamento/tequendama-cali",
    grokAnalysis: "Amplio apartamento en el sector Tequendama, con vista panorámica desde el piso 8. Tres alcobas, dos baños completos, cocina americana y balcón.",
    advisorNote: "A dos cuadras del Club Tequendama y del CAM. Sector seguro y residencial. Propietario acepta perros de raza mediana."
  },
  {
    id: "prop-arr-15",
    title: "Casa en Arriendo El Caney Cali",
    type: "casa",
    zone: "Sur",
    barrio: "El Caney",
    price: 2200000,
    ...
    address: "Calle 16 # 93-10, Casa 4, El Caney, Cali",
    phone: "+57 315 120 2340",
    owner: "Familia González Ríos",
    source: "OLX Cali",
    sourceLink: "https://olx.com.co/item/casa-arriendo-el-caney-cali",
    grokAnalysis: "Casa de dos plantas en El Caney con jardín privado, garaje doble y cuarto de servicio. Cuatro habitaciones, sala-comedor independiente.",
    advisorNote: "Casa libre de hipotecas. Propietario en Bogotá, negocia por video llamada. Contrato mínimo 1 año con opción a renovación."
  }
];
